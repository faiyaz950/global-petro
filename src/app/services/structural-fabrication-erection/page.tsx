            ...
            <div className="container relative mx-auto max-w-6xl px-4 text-center z-20">
              <div className="mb-8 animate-fadeIn">
                <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 shadow-2xl">
                  ...
                  <span className="text-white font-medium tracking-wide text-sm" style={{ fontFamily: "'Playfair Display', serif" }}>🏭 Structural Fabrication & Erection</span>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6 animate-fadeInUp">
                  ...
                  <p className="text-gray-600 leading-relaxed text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Our Structural Fabrication & Erection services deliver custom-engineered steel structures that form the critical framework for industrial facilities. We combine advanced fabrication techniques with certified welding processes to create structures that meet the most demanding specifications.
                  </p>
                  
                  <p className="text-gray-600 leading-relaxed text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
                    From design to delivery, every project benefits from our rigorous quality control, certified welders, and comprehensive testing protocols ensuring structural integrity and long-term reliability.
                  </p>
                </div>
          ...
          <section className="py-24 bg-white relative overflow-hidden">
            <div className="container mx-auto max-w-7xl px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  {
                    title: 'Steel Platform Fabrication',
                    description: 'Custom-designed platforms, walkways, and access structures.',
                    icon: <Factory size={32} />
                  },
                  {
                    title: 'Equipment Supports',
                    description: 'Heavy-duty supports for vessels, tanks, and machinery.',
                    icon: <Wrench size={32} />
                  },
                  {
                    title: 'Modular Assemblies',
                    description: 'Pre-fabricated modular structures for rapid deployment.',
                    icon: <Zap size={32} />
                  },
                  {
                    title: 'Certified Welding',
                    description: 'ASME and AWS certified welding services with NDT testing.',
                    icon: <CheckCircle size={32} />
                  },
                  {
                    title: 'Erection Services',
                    description: 'Safe and efficient installation of fabricated structures.',
                    icon: <Shield size={32} />
                  },
                  {
                    title: 'Quality Assurance',
                    description: 'Comprehensive QA/QC programs with material traceability.',
                    icon: <Award size={32} />
                  }
                ].map((service, index) => (
                  <div
          ...
          <section className="py-24 bg-black relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-4xl px-4 text-center relative z-10">
              ...
              <p className="text-xl text-white/70 mb-10" style={{ fontFamily: "'Playfair Display', serif" }}>
                Let's discuss how our Structural Fabrication & Erection services can support your project.
              </p>
