            ...
            <div className="container relative mx-auto max-w-6xl px-4 text-center z-20">
              <div className="mb-8 animate-fadeIn">
                <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 shadow-2xl">
                  ...
                  <span className="text-white font-medium tracking-wide text-sm" style={{ fontFamily: "'Playfair Display', serif" }}>👥 Manpower Supply</span>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6 animate-fadeInUp">
                  ...
                  <p className="text-gray-600 leading-relaxed text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Our Manpower Supply service provides access to over 160 highly skilled professionals, each certified to international standards. We understand that the quality of your workforce directly impacts project success, which is why we maintain rigorous selection and certification processes.
                  </p>
                  
                  <p className="text-gray-600 leading-relaxed text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
                    From engineers and supervisors to welders, riggers, and support staff, our team is ready to integrate seamlessly into your project, bringing expertise, reliability, and commitment to excellence.
                  </p>
                </div>
          ...
          <section className="py-24 bg-white relative overflow-hidden">
            <div className="container mx-auto max-w-7xl px-4">
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                {[
                  {
                    title: 'Engineers & Supervisors',
                    description: 'Qualified engineers and supervisors with project management expertise.',
                    icon: <GraduationCap size={32} />
                  },
                  {
                    title: 'Certified Welders',
                    description: 'ASME, AWS, and CSWIP certified welders for all welding applications.',
                    icon: <Wrench size={32} />
                  },
                  {
                    title: 'Riggers & Operators',
                    description: 'Experienced riggers and heavy equipment operators.',
                    icon: <Zap size={32} />
                  },
                  {
                    title: 'Quality Inspectors',
                    description: 'QA/QC inspectors with NDT and material testing certifications.',
                    icon: <CheckCircle size={32} />
                  },
                  {
                    title: 'Safety Personnel',
                    description: 'HSE officers and safety supervisors with comprehensive training.',
                    icon: <Shield size={32} />
                  },
                  {
                    title: 'Support Staff',
                    description: 'Administrative, logistics, and technical support personnel.',
                    icon: <Users size={32} />
                  }
                ].map((service, index) => (
                  <div
          ...
          <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-rose-50 relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-7xl px-4 relative z-10">
              ...
              <div className="grid md:grid-cols-4 gap-6">
                {['ASME', 'AWS', 'CSWIP', 'ISO 9001:2015'].map((cert, index) => (
                  <div
                    key={index}
                    className="text-center p-6 glass-effect rounded-2xl shadow-lg hover:shadow-xl transition-all duration-500 hover-tilt animate-scaleIn"
                    style={{ animationDelay: `${index * 0.1}s`, fontFamily: "'Playfair Display', serif" }}
                  >
                    <div className="inline-flex p-4 rounded-xl bg-gradient-to-br from-[#932445] to-[#d63865] mb-4 text-white">
                      <Award size={32} />
                    </div>
                    <h3 className="text-xl font-bold text-gray-900" style={{ fontFamily: "'Playfair Display', serif" }}>{cert}</h3>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="py-24 bg-black relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-4xl px-4 text-center relative z-10">
              ...
              <p className="text-xl text-white/70 mb-10" style={{ fontFamily: "'Playfair Display', serif" }}>
                Let's discuss how our Manpower Supply services can support your project needs.
              </p>
