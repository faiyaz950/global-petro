...
import { ClipboardList, CheckCircle, Shield, Award, Users, Target, Zap, Code } from 'lucide-react';
...
const heroSlides = [
  {
    ...
    text: 'From conceptual studies to detailed engineering, 3D modeling using advanced software like AutoCAD, PDMS, and simulation tools for optimal design solutions that maximize efficiency and minimize costs.'
  },
  {
    imageId: 'project-1',
    text: 'Advanced 3D Modeling and Design with AutoCAD, PDMS, and BIM Technologies'
  },
  {
    imageId: 'service-construction',
    text: 'Comprehensive Engineering Solutions from Feasibility to Construction Support'
  },
  {
    imageId: 'service-infrastructure',
    text: 'Detailed Engineering Packages with Clash Detection and Optimization'
  },
  {
    imageId: 'pipeline-installation',
    text: 'Process Design, P&ID Development, and Equipment Sizing Services'
  },
  {
    imageId: 'well-hookup',
    text: 'Multi-disciplinary Engineering Coordination and Integrated Design Solutions'
  }
];
                ...
                return (
                  ...
                  >
                    <img
                      ...
                      alt={slideImage?.description || 'Engineering & Design'}
            ...
            <div className="container relative mx-auto max-w-6xl px-4 text-center z-20">
              <div className="mb-8 animate-fadeIn">
                <div className="inline-flex items-center gap-3 px-6 py-3 bg-white/10 backdrop-blur-xl rounded-full border border-white/20 shadow-2xl">
                  ...
                  <span className="text-white font-medium tracking-wide text-sm" style={{ fontFamily: "'Playfair Display', serif" }}>📐 Engineering & Design</span>
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6 animate-fadeInUp">
                  ...
                  <p className="text-gray-600 leading-relaxed text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Our Engineering & Design services transform concepts into detailed, executable plans using cutting-edge software and industry best practices. We provide comprehensive engineering solutions from feasibility studies through detailed design and construction support.
                  </p>
                  
                  <p className="text-gray-600 leading-relaxed text-lg" style={{ fontFamily: "'Playfair Display', serif" }}>
                    With expertise in 3D modeling, simulation, and advanced design tools, we optimize solutions for efficiency, cost-effectiveness, and compliance with international standards.
                  </p>
                </div>
                ...
                {[
                  {
                    ...
                    description: 'Feasibility studies and preliminary design for project planning.',
                    icon: <Target size={32} />
                  },
                  {
                    title: '3D Modeling & Design',
                    description: 'Advanced 3D modeling using AutoCAD, PDMS, and BIM technologies.',
                    icon: <Code size={32} />
                  },
                  {
                    title: 'Detailed Engineering',
                    description: 'Comprehensive detailed design packages for construction.',
                    icon: <ClipboardList size={32} />
                  },
                  {
                    title: 'Simulation & Analysis',
                    description: 'Process simulation and structural analysis for optimization.',
                    icon: <Zap size={32} />
                  },
                  {
                    title: 'Technical Documentation',
                    description: 'Complete technical specifications and construction drawings.',
                    icon: <CheckCircle size={32} />
                  },
                  {
                    title: 'Design Review & Support',
                    description: 'Design review services and construction support engineering.',
                    icon: <Award size={32} />
                  }
                ].map((service, index) => (
                  <div
          ...
          <section className="py-24 bg-black relative overflow-hidden">
            ...
            <div className="container mx-auto max-w-4xl px-4 text-center relative z-10">
              ...
              <p className="text-xl text-white/70 mb-10" style={{ fontFamily: "'Playfair Display', serif" }}>
                Let's discuss how our Engineering & Design services can bring your project to life.
              </p>
