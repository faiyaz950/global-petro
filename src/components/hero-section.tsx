  ...
  const toggleMute = () => {
    ...
    if (iframeRef.current) {
      const newSrc = isMuted
        ? "https://www.youtube.com/embed/Ld_HrS74NyY?autoplay=1&mute=0&loop=1&playlist=Ld_HrS74NyY&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1"
        : "https://www.youtube.com/embed/Ld_HrS74NyY?autoplay=1&mute=1&loop=1&playlist=Ld_HrS74NyY&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1";
    ...
    <div className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-0">
        <iframe
          ...
          src="https://www.youtube.com/embed/Ld_HrS74NyY?autoplay=1&mute=1&loop=1&playlist=Ld_HrS74NyY&controls=0&showinfo=0&rel=0&modestbranding=1&playsinline=1"
          title="Background"
          frameBorder="0"
